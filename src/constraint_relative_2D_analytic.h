...
class ConstraintRelative2DAnalytic : public ConstraintAnalytic
{
    public:
         ...
         **/
        ConstraintRelative2DAnalytic(FeatureBase* _ftr_ptr, ConstraintType _type, FrameBase* _frame_ptr, bool _apply_loss_function = false, ConstraintStatus _status = CTR_ACTIVE) :
            ConstraintAnalytic(_ftr_ptr, _type, _frame_ptr, _apply_loss_function, _status, _frame_ptr->getPPtr(), _frame_ptr->getOPtr(), _ftr_ptr->getFramePtr()->getPPtr(), _ftr_ptr->getFramePtr()->getOPtr())
        {
            //
        }
         ...
         **/
        ConstraintRelative2DAnalytic(FeatureBase* _ftr_ptr, ConstraintType _type, FeatureBase* _ftr_other_ptr, bool _apply_loss_function = false, ConstraintStatus _status = CTR_ACTIVE) :
            ConstraintAnalytic(_ftr_ptr, _type, _ftr_other_ptr, _apply_loss_function, _status, _ftr_ptr->getFramePtr()->getPPtr(), _ftr_ptr->getFramePtr()->getOPtr(), _ftr_other_ptr->getFramePtr()->getPPtr(), _ftr_other_ptr->getFramePtr()->getOPtr() )
        {
            //
        }
         ...
         **/
        ConstraintRelative2DAnalytic(FeatureBase* _ftr_ptr, ConstraintType _type, LandmarkBase* _landmark_ptr, bool _apply_loss_function = false, ConstraintStatus _status = CTR_ACTIVE) :
            ConstraintAnalytic(_ftr_ptr, _type, _landmark_ptr, _apply_loss_function, _status, _ftr_ptr->getFramePtr()->getPPtr(), _ftr_ptr->getFramePtr()->getOPtr(), _landmark_ptr->getPPtr(), _landmark_ptr->getOPtr())
        {
            //
        }
