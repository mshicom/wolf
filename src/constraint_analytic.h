...
class ConstraintAnalytic: public ConstraintBase
{
    ...
    public:
         ...
         *
         **/
        ConstraintAnalytic(FeatureBase* _ftr_ptr, ConstraintType _type, bool _apply_loss_function, ConstraintStatus _status,
         ...
         *
         **/
        ConstraintAnalytic(FeatureBase* _ftr_ptr, ConstraintType _type, FrameBase* _frame_ptr, bool _apply_loss_function, ConstraintStatus _status,
                         StateBlock* _state0Ptr,
                         StateBlock* _state1Ptr = nullptr,
                         StateBlock* _state2Ptr = nullptr,
                         StateBlock* _state3Ptr = nullptr,
         ...
         *
         **/
        ConstraintAnalytic(FeatureBase* _ftr_ptr, ConstraintType _type, FeatureBase* _feature_ptr, bool _apply_loss_function, ConstraintStatus _status,
                         StateBlock* _state0Ptr,
                         StateBlock* _state1Ptr = nullptr,
                         StateBlock* _state2Ptr = nullptr,
                         StateBlock* _state3Ptr = nullptr,
         ...
         *
         **/
        ConstraintAnalytic(FeatureBase* _ftr_ptr, ConstraintType _type, LandmarkBase* _landmark_ptr, bool _apply_loss_function, ConstraintStatus _status,
                         StateBlock* _state0Ptr,
                         StateBlock* _state1Ptr = nullptr,
                         StateBlock* _state2Ptr = nullptr,
                         StateBlock* _state3Ptr = nullptr,
