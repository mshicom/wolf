...
///  Additive group traits
template<class Class>
struct AdditiveGroup : AdditiveGroupTraits<Class>{};
...
//  BOOST_CONCEPT_ASSERT((IsGroup<G>));  // TODO: check additive
//  BOOST_CONCEPT_ASSERT((IsGroup<H>));  // TODO: check additive
...
public:
 ...
 operator-(const DirectSum& other) const {
    return DirectSum(g()-other.g(), h()-other.h());
  }
