...
ProcessorTracker::ProcessorTracker(ProcessorType _tp, std::string _type, const unsigned int _max_new_features) :
        ProcessorBase(_tp, _type), origin_ptr_(nullptr), last_ptr_(nullptr), incoming_ptr_(nullptr),
