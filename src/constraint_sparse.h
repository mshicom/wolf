...
class ConstraintSparse: public ConstraintBase
{
    ...
    public:
         ...
         *
         **/
        ConstraintSparse(FeatureBase* _ftr_ptr, ConstraintType _type, bool _apply_loss_function, ConstraintStatus _status,
         ...
         *
         **/
        ConstraintSparse(FeatureBase* _ftr_ptr, ConstraintType _type, FrameBase* _frame_ptr, bool _apply_loss_function, ConstraintStatus _status,
                         StateBlock* _state0Ptr,
                         StateBlock* _state1Ptr = nullptr,
                         StateBlock* _state2Ptr = nullptr,
                         StateBlock* _state3Ptr = nullptr,
         ...
         *
         **/
        ConstraintSparse(FeatureBase* _ftr_ptr, ConstraintType _type, FeatureBase* _feature_ptr, bool _apply_loss_function, ConstraintStatus _status,
                         StateBlock* _state0Ptr,
                         StateBlock* _state1Ptr = nullptr,
                         StateBlock* _state2Ptr = nullptr,
                         StateBlock* _state3Ptr = nullptr,
         ...
         *
         **/
        ConstraintSparse(FeatureBase* _ftr_ptr, ConstraintType _type, LandmarkBase* _landmark_ptr, bool _apply_loss_function, ConstraintStatus _status,
                         StateBlock* _state0Ptr,
                         StateBlock* _state1Ptr = nullptr,
                         StateBlock* _state2Ptr = nullptr,
                         StateBlock* _state3Ptr = nullptr,
...
ConstraintSparse<MEASUREMENT_SIZE,
                 ...
                 BLOCK_7_SIZE,
                 BLOCK_8_SIZE,
                 BLOCK_9_SIZE>::ConstraintSparse(FeatureBase* _ftr_ptr, ConstraintType _type, bool _apply_loss_function, ConstraintStatus _status,
                                                 StateBlock* _state0Ptr,
            ...
            ConstraintBase(_type, _apply_loss_function, _status),
...
ConstraintSparse<MEASUREMENT_SIZE,
                 ...
                 BLOCK_7_SIZE,
                 BLOCK_8_SIZE,
                 BLOCK_9_SIZE>::ConstraintSparse(FeatureBase* _ftr_ptr, ConstraintType _type, FrameBase* _frame_ptr, bool _apply_loss_function, ConstraintStatus _status,
                                                 StateBlock* _state0Ptr,
                                                 StateBlock* _state1Ptr,
                                                 StateBlock* _state2Ptr,
                                                 StateBlock* _state3Ptr,
                                                 ...
                                                 StateBlock* _state8Ptr,
                                                 StateBlock* _state9Ptr ) :
            ConstraintBase(_type, _frame_ptr, _apply_loss_function, _status),
            state_ptr_vector_({_state0Ptr,_state1Ptr,_state2Ptr,_state3Ptr,_state4Ptr,_state5Ptr,_state6Ptr,_state7Ptr,_state8Ptr,_state9Ptr}),
            state_block_sizes_vector_({BLOCK_0_SIZE,BLOCK_1_SIZE,BLOCK_2_SIZE,BLOCK_3_SIZE,BLOCK_4_SIZE,BLOCK_5_SIZE,BLOCK_6_SIZE,BLOCK_7_SIZE,BLOCK_8_SIZE,BLOCK_9_SIZE})
        {
            resizeVectors();
...
ConstraintSparse<MEASUREMENT_SIZE,
                 ...
                 BLOCK_7_SIZE,
                 BLOCK_8_SIZE,
                 BLOCK_9_SIZE>::ConstraintSparse(FeatureBase* _ftr_ptr, ConstraintType _type, FeatureBase* _feature_ptr, bool _apply_loss_function, ConstraintStatus _status,
                                                 StateBlock* _state0Ptr,
                                                 StateBlock* _state1Ptr,
                                                 StateBlock* _state2Ptr,
                                                 StateBlock* _state3Ptr,
                                                 ...
                                                 StateBlock* _state8Ptr,
                                                 StateBlock* _state9Ptr ) :
            ConstraintBase( _type, _feature_ptr, _apply_loss_function, _status),
            state_ptr_vector_({_state0Ptr,_state1Ptr,_state2Ptr,_state3Ptr,_state4Ptr,_state5Ptr,_state6Ptr,_state7Ptr,_state8Ptr,_state9Ptr}),
            state_block_sizes_vector_({BLOCK_0_SIZE,BLOCK_1_SIZE,BLOCK_2_SIZE,BLOCK_3_SIZE,BLOCK_4_SIZE,BLOCK_5_SIZE,BLOCK_6_SIZE,BLOCK_7_SIZE,BLOCK_8_SIZE,BLOCK_9_SIZE})
        {
            resizeVectors();
...
ConstraintSparse<MEASUREMENT_SIZE,
                 ...
                 BLOCK_7_SIZE,
                 BLOCK_8_SIZE,
                 BLOCK_9_SIZE>::ConstraintSparse(FeatureBase* _ftr_ptr, ConstraintType _type, LandmarkBase* _landmark_ptr, bool _apply_loss_function, ConstraintStatus _status,
                                                 StateBlock* _state0Ptr,
                                                 StateBlock* _state1Ptr,
                                                 StateBlock* _state2Ptr,
                                                 StateBlock* _state3Ptr,
                                                 ...
                                                 StateBlock* _state8Ptr,
                                                 StateBlock* _state9Ptr ) :
            ConstraintBase( _type, _landmark_ptr, _apply_loss_function, _status),
            state_ptr_vector_({_state0Ptr,_state1Ptr,_state2Ptr,_state3Ptr,_state4Ptr,_state5Ptr,_state6Ptr,_state7Ptr,_state8Ptr,_state9Ptr}),
            state_block_sizes_vector_({BLOCK_0_SIZE,BLOCK_1_SIZE,BLOCK_2_SIZE,BLOCK_3_SIZE,BLOCK_4_SIZE,BLOCK_5_SIZE,BLOCK_6_SIZE,BLOCK_7_SIZE,BLOCK_8_SIZE,BLOCK_9_SIZE})
        {
            resizeVectors();
