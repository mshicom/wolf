...
class SensorBase : public NodeLinked<HardwareBase, ProcessorBase>
{
    ...
    public:
         ...
         *
         **/
        SensorBase(const SensorType & _type, StateBlock* _p_ptr, StateBlock* _o_ptr, StateBlock* _intr_ptr, const unsigned int _noise_size, const bool _extr_dyn = false);
         ...
         *
         **/
        SensorBase(const SensorType & _type, StateBlock* _p_ptr, StateBlock* _o_ptr, StateBlock* _intr_ptr, const Eigen::VectorXs & _noise_std, const bool _extr_dyn = false);
